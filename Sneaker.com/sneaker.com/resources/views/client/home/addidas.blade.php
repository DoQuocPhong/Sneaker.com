    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-5 col-md-5 text-right">
                <p>Find total {{count($productadidas)}} Products</p>
            </div>
            <div class="col-sm-12">
                <hr>
            </div>
...
<div class="product-list">
    <div class="row">
        @foreach($productadidas as $pro)
            <div class="col-lg-4 col-sm-6">
                <div class="product-item">
                    <div class="pi-pic">
                        <a href="<?php echo url('product')?>/{{$pro->id}}">
                            <img src="<?php echo asset('public/upload/product')?>/{{$pro->image}}"
                        ...
                        <ul>
                            ...
                            <li class="quick-view"><a href="#">
                                    <button type="button" class="btn btn-light" data-toggle="modal"
                                            data-target="#adidas{{$pro->id}}"
                                            data-whatever="@mdo">+ Quick View
                                    </button>
                                </a></li>
                            <div class="modal fade" id="adidas{{$pro->id}}" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="adidass{{$pro->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="adidass{{$pro->id}}">{{$pro->name}}</h5>
