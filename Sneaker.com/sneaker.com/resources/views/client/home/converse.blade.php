    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-5 col-md-5 text-right">
                <p>Find total {{count($productconverse)}} Products</p>
            </div>
            <div class="col-sm-12">
                <hr>
            </div>
...
<div class="product-list">
    <div class="row">
        @foreach($productconverse as $pro)
            <div class="col-lg-4 col-sm-6">
                <div class="product-item">
                    <div class="pi-pic">
                        <a href="<?php echo url('product')?>/{{$pro->id}}">
                            <img src="<?php echo asset('public/upload/product')?>/{{$pro->image}}" alt="" style="width: auto;height: 200px">
                        </a>
                        ...
                        <ul>
                            ...
                            <li class="quick-view"><a href="#">
                                    <button type="button" class="btn btn-light" data-toggle="modal"
                                            data-target="#converses{{$pro->id}}"
                                            data-whatever="@mdo">+ Quick View
                                    </button>
                                </a></li>
                            <div class="modal fade" id="converses{{$pro->id}}" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="conversess{{$pro->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="conversess{{$pro->id}}">{{$pro->name}}</h5>
                    ...
                    <div class="pi-text">
{{--                        <div class="catagory-name">{{$pro->name}}</div>--}}
                        <a href="<?php echo url('product')?>/{{$pro->id}}">
                            <h5>{{$pro->name}}</h5>
                        </a>
                        <div class="product-price">
                            @if($pro->promotion_price!=0)
                                {{number_format($pro->promotion_price)}}
                                <span>{{number_format($pro->unit_price)}}</span>
                            @else
                                {{number_format($pro->unit_price)}}
                            @endif
                        </div>
