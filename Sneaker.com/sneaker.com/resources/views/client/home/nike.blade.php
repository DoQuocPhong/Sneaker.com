    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-lg-5 col-md-5 text-right">
                <p>Find total {{count($productnike)}} Products</p>
            </div>
            <div class="col-sm-12">
                <hr>
            </div>
                        ...
                        <ul>
                            ...
                            <li class="quick-view"><a href="#">
                                    <button type="button" class="btn btn-light" data-toggle="modal"
                                            data-target="#nike{{$pro->id}}"
                                            data-whatever="@mdo">+ Quick View
                                    </button>
                                </a></li>
                            <div class="modal fade" id="nike{{$pro->id}}" tabindex="-1"
                                 role="dialog"
                                 aria-labelledby="nikes{{$pro->id}}" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="nikes{{$pro->id}}">{{$pro->name}}</h5>
